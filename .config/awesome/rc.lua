...
user = {
    ...
    file_manager_gui = "dolphin",
    editor = "alacritty --class editor -e vim",
    email_client = "qutebrowser gmail.com",
    music_client = "alacritty --class music -e ncmpcpp",
    ...
    dirs = {
        ...
        -- are not lost
        screenshots = os.getenv("XDG_SCREENSHOTS_DIR") or "~/Screenshots",
    },
    ...
    openweathermap_key = "e7783737d3ab05e8e7e9ce2a166631f9",
    openweathermap_city_id = "2745912",
...
local function set_wallpaper(s)
    ...
    if beautiful.wallpaper then
        ...
        -- >> Method 4: Set wallpaper with setbg
        awful.spawn.with_shell("setbg -r")
    end
end
